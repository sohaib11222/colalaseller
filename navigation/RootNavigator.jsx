...
import SocialWebView from "../components/SocialWebView";
      ...
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {!shouldShowAuth ? (
          ...
          <>
            ...
            <Stack.Screen name="SocialWebView" component={SocialWebView} />
            <Stack.Screen name="VideoPlayerWebView" component={VideoPlayerWebView} />
          </>
        ) : (
